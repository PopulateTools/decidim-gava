...
Decidim.register_component(:gava_engine) do |component|
  ...
  component.icon = "decidim/gava_engine/icon.svg"
  ...
  #   resource.model_class_name = "Decidim::GavaEngine::SomeResource"
  #   resource.template = "decidim/gava_engine/some_resources/linked_some_resources"
  # end
